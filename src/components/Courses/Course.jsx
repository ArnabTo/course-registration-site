    ...
    return (
        <div>
            <div className="courseContainer bg-white rounded-lg">
             ...
             <img className=" w-[500px] h-[150px] rounded-md mb-4 " src={course_thumbnail}/>
             <div className="courseDtails">
              ...
              <span className="flex justify-between mb-2 ">
               ...
               <p className='text-[#1C1B1B99] text-base font-medium'><FontAwesomeIcon className=' mr-2 '  icon={faHourglassStart} />Credit: {credit_hour}hr</p>
              </span>
             </div>
             <button 
